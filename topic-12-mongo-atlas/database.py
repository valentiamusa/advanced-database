...
def initialize():
    global db, owners_collection, pets_collection
    uri = "mongodb+srv://<db-user>:<password>@class-demo.lp2qy8u.mongodb.net/?appName=Class-Demo"    # Create a new client and connect to the server
...
def setup_database(database_name="pets"):
    ...
    Mongo creates collections lazily when they are accessed, so touching the
